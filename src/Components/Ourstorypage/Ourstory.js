...
const Ourstory = () => {
  ...
  // Use react-spring's useSpring hook to animate the sides
  ...
  return (
    ...
    <div className="storyanimation-container">
      ...
      <div className="storyright-content  px-4">
        <h2 className="storyintro ">At Momeals, our mission is to combat hunger and reduce food waste.</h2>
      </div>
      ...
      {isOpen && (
        ...
        <div className="storymain_container">
          ...
          {/* <div className="storybrake">
            <br className="storyline_break"></br>
          </div> */}
    ...
    <div className='storysection-cards '>
     <Row xs={1} md={1} lg={1} xl={3} className="g-0">
     {
        data.map((dta,id)=>{
            return(
                <Col >
                  <div className='storysection-cards-class p-lg-4 p-md-5 p-4 '  style={{background: dta.background,color:"white",borderRadius:"0%"}}>
